(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactBoostrapSelect"] = factory(require("jQuery"), require("react"), require("react-dom"));
	else
		root["ReactBoostrapSelect"] = factory(root["jQuery"], root["react"], root["react-dom"]);
	...
	var SelectPicker = function (_React$Component) {
	    ...
	    _createClass(SelectPicker, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.element.on("changed.bs.select", function () {
	                _this2.props.onChange(_this2.element.selectpicker("val"));
	            });
	        }
	    }, {
